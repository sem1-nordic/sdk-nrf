...
* The ``<revents>`` value is a hexadecimal string. It represents the returned events, which could be a combination of ZSOCK_POLLIN, ZSOCK_POLLERR, ZSOCK_POLLHUP and ZSOCK_POLLNVAL.
